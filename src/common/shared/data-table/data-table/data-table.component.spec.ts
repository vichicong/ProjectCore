  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [
        ...
        mockComponent({ selector: 'data-table-quantity' }),
        mockComponent({ selector: 'data-table-footer', inputs: ['page', 'count', 'quantity', 'quantityPerPage', 'useLink'] })
      ],
      providers: [
        { provide: DataTableAccessor, useClass: MockAccessor },
        { provide: ToastsManager, useValue: { success: () => {}, error: () => {} } }
      ]
    })
    .compileComponents()
  }))
