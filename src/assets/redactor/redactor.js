...
(function($)
{
	...
	$.Redactor.modules = ['air', 'autosave', 'block', 'buffer', 'build', 'button', 'caret', 'clean', 'code', 'core', 'detect', 'dropdown',
						  ...
						  'progress', 'selection', 'shortcuts', 'storage', 'toolbar', 'upload', 'uploads3', 'common/utils',
			...
			return {
				...
				insert: function(json, direct, e)
				{
					...
					if (this.events.dropImage !== false)
					{
						...
						$img.attr('src', json.url || json.fullUrl);
		...
		link: function()
		{
			return {
				...
				buildLinkFromModal: function()
				{
					...
					// url
					link.url = $('#redactor-link-url').val();
				...
				send: function(formData, e)
				{
					...
					try {
						if (this.opts.authorizationToken) {
							xhr.setRequestHeader("Authorization", this.opts.authorizationToken);
						}
					} catch(e) { }
